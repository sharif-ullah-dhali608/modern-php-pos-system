        ...
        <div class="p-6">
            <div class="mb-6 slide-in">
                <div class="flex items-center gap-4 mb-4">
                    <a href="/pos/units/unit_list.php" class="w-10 h-10 flex items-center justify-center rounded-lg bg-white/10 hover:bg-white/20 text-white transition-all">
                ...
                <form action="save_unit.php" method="POST">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        <div class="lg:col-span-2 space-y-6">
                            <div>
                                <label class="block text-sm font-semibold text-white mb-2">Unit Name <span class="text-red-400">*</span></label>
                                <input type="text" name="unit_name" value="<?= htmlspecialchars($d['unit_name']); ?>" class="w-full bg-white/10 border border-white/20 rounded-lg px-4 py-3 text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent" required>
                            </div>
                            <div>
                            ...
                            <div>
                                <label class="block text-sm font-semibold text-white mb-2">Unit Details</label>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="space-y-3">
                                ...
                                <a href="unit_list.php" class="block w-full bg-white/10 text-white font-semibold py-3 rounded-lg text-center hover:bg-white/20 transition-all">Cancel</a>
                            </div>
                        </div>
                    </div>
                </form>
