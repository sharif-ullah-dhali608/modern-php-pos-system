    ...
    <main id="main-content" class="flex-1 ml-64 main-content min-h-screen">
        ...
        <div class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <a href="currency/add_currency.php" class="bg-white rounded-xl p-6 shadow-lg border border-slate-100 hover:scale-105 transition-transform slide-in group cursor-pointer" style="animation-delay: 0.1s;">
                    <div class="flex items-center gap-4">
                ...
                <a href="stores/store_list.php" class="bg-white rounded-xl p-6 shadow-lg border border-slate-100 hover:scale-105 transition-transform slide-in group cursor-pointer" style="animation-delay: 0.2s;">
                    <div class="flex items-center gap-4">
