...
if(isset($_POST['user_id'])) {
    ...
    if(mysqli_num_rows($query_run) > 0) {
        ...
        $module_definitions = [
            ...
            'quotation' => ['label' => 'Quotations', 'icon' => 'fa-file-invoice', 'perms' => ['Read Quotation List', 'Create Quotation', 'Update Quotation', 'Delete Quotation', 'View All Stores Data']],
            'installment' => ['label' => 'Installments', 'icon' => 'fa-calendar-alt', 'perms' => ['Read Installment List', 'Create Installment', 'Update Installment', 'Delete Installment', 'Installment Payment', 'Installment Overview', 'View All Stores Data']],
            'expenditure' => ['label' => 'Expenses', 'icon' => 'fa-wallet', 'perms' => ['Read Expense', 'Create Expense', 'Update Expense', 'Delete Expense', 'Read Expense Category', 'Create Expense Category', 'Update Expense Category', 'Delete Expense Category', 'Expense Monthwise', 'Expense Summary', 'View All Stores Data']],
            'sell' => ['label' => 'Sells', 'icon' => 'fa-shopping-cart', 'perms' => ['View Sell Invoice', 'View Sell List', 'Create Sell', 'Update Info', 'Delete Sell', 'Sell Payment', 'Create Due', 'Create Return', 'View Return List', 'Update Return', 'Delete Return', 'Send Sell Invoice via SMS', 'Send Sell Invoice via Email', 'Read Sell Log', 'View All Stores Data']],
            'purchase' => ['label' => 'Purchases', 'icon' => 'fa-shopping-bag', 'perms' => ['Create Invoice', 'View Invoice List', 'Update Info', 'Delete Invoice', 'Payment', 'Create Due', 'Create Return', 'View Return List', 'Update Return', 'Delete Return', 'Read Purchase Log', 'Import Stock', 'View All Stores Data']],
            'transfer' => ['label' => 'Transfers', 'icon' => 'fa-exchange-alt', 'perms' => ['Read Transfer', 'Add Transfer', 'Update Transfer', 'Cancel Transfer', 'View All Stores Data']],
            'giftcard' => ['label' => 'Gift Cards', 'icon' => 'fa-gift', 'perms' => ['Read Giftcard', 'Add Giftcard', 'Update Giftcard', 'Delete Giftcard', 'Giftcard Topup', 'Read Giftcard Topup', 'Delete Giftcard Topup', 'View All Stores Data']],
            'product' => ['label' => 'Products', 'icon' => 'fa-box-open', 'perms' => ['Read Product List', 'Create Product', 'Update Product', 'Delete Product', 'Import Product', 'Product Bulk Action', 'Delete All Product', 'Read Stock Alert', 'Read Expired Product List', 'Barcode Print', 'Restore All Product', 'View All Stores Data']],
            'category' => ['label' => 'Categories', 'icon' => 'fa-th-list', 'perms' => ['Read Category List', 'Create Category', 'Update Category', 'Delete Category', 'View Category Details', 'View All Stores Data']],
            'supplier' => ['label' => 'Suppliers', 'icon' => 'fa-truck', 'perms' => ['Read Supplier List', 'Create Supplier', 'Update Supplier', 'Delete Supplier', 'Read Supplier Profile', 'View All Stores Data']],
            'brand' => ['label' => 'Brands', 'icon' => 'fa-tags', 'perms' => ['Read Brand List', 'Create Brand', 'Update Brand', 'Delete Brand', 'Read Brand Profile', 'View All Stores Data']],
            'storebox' => ['label' => 'Boxes', 'icon' => 'fa-archive', 'perms' => ['Read Box', 'Create Box', 'Update Box', 'Delete Box', 'View All Stores Data']],
            'unit' => ['label' => 'Units', 'icon' => 'fa-balance-scale', 'perms' => ['Read Unit', 'Create Unit', 'Update Unit', 'Delete Unit', 'View All Stores Data']],
            'taxrate' => ['label' => 'Tax Rates', 'icon' => 'fa-percentage', 'perms' => ['Read Taxrate', 'Create Taxrate', 'Update Taxrate', 'Delete Taxrate', 'View All Stores Data']],
            'loan' => ['label' => 'Loans', 'icon' => 'fa-hand-holding-usd', 'perms' => ['Read Loan', 'Read Loan Summary', 'Take Loan', 'Update Loan', 'Delete Loan', 'Loan Pay', 'View All Stores Data']],
            'customer' => ['label' => 'Customers', 'icon' => 'fa-users', 'perms' => ['Read Customer List', 'Read Customer Profile', 'Create Customer', 'Update Customer', 'Delete Customer', 'Add Balance', 'Substract Balance', 'Read Transaction List', 'View All Stores Data']],
            'user' => ['label' => 'Users', 'icon' => 'fa-user-cog', 'perms' => ['Read User List', 'Create User', 'Update User', 'Delete User', 'Change Password', 'View All Stores Data']],
            'usergroup' => ['label' => 'User Groups', 'icon' => 'fa-users-cog', 'perms' => ['Read Usergroup List', 'Create Usergroup', 'Update Usergroup', 'Delete Usergroup', 'View All Stores Data']],
            'currency' => ['label' => 'Currencies', 'icon' => 'fa-money-bill-wave', 'perms' => ['Read Currency', 'Add Currency', 'Update Currency', 'Change Currency', 'Delete Currency', 'View All Stores Data']],
            'filemanager' => ['label' => 'Files', 'icon' => 'fa-folder-open', 'perms' => ['Read Filemanager', 'View All Stores Data']],
            'payment_method' => ['label' => 'Payments', 'icon' => 'fa-credit-card', 'perms' => ['Read Payment Method List', 'Create Payment Method', 'Update Payment Method', 'Delete Payment Method', 'Active/Inactive', 'View All Stores Data']],
